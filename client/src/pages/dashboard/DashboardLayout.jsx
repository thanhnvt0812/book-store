...
const Dashboard = () => {
  ...
  const activePath = location.pathname; // Đường dẫn đang active
        ...
        <div className="flex-grow flex flex-col justify-between text-gray-500 bg-gray-800">
          <nav className="flex flex-col mx-4 my-6 space-y-4">
            <Link
              ...
              className={`inline-flex items-center justify-center py-3 ${
                activePath === "/dashboard"
                  ...
                  : "hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg"
              }`}
            >
            ...
            <Link
              ...
              className={`inline-flex items-center justify-center py-3 ${
                activePath === "/dashboard/add-new-book"
                  ? "text-purple-600 bg-white rounded-lg"
                  : "hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg"
              }`}
            >
            ...
            <Link
              ...
              className={`inline-flex items-center justify-center py-3 ${
                activePath === "/dashboard/manage-books"
                  ? "text-purple-600 bg-white rounded-lg"
                  : "hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg"
              }`}
            >
          ...
          <div className="flex flex-shrink-0 items-center ml-auto">
            <div className="inline-flex items-center p-2 rounded-lg">
              ...
              <div className="hidden md:flex md:flex-col md:items-end md:leading-tight">
                ...
                <span className="text-sm text-gray-600">{user.user.role}</span>
              </div>
